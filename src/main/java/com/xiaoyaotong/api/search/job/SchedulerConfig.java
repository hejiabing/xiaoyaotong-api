...
public class SchedulerConfig {
    ...
    */
    ...
    public void init(){
        ...
        //增量同步spu,每7分钟一次
        taskScheduler.addJob("syncIncrementSpuJob","group2","trigger2","t2",EsSyncIncrementSpuJob.class,"0 */3 * * * ?");
        //全量同步sku，每天晚上2点
        ...
        //增量同步公司自己的sku,每3分钟一次
        taskScheduler.addJob("EsSyncIncrementCompanyItemJob","group6","trigger6","t6",EsSyncIncrementCompanyItemJob.class,"0 */1 * * * ?");
    }
