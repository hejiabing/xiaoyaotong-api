...
public class SchedulerConfig {
    ...
    */
    ...
    public void init(){
        ...
        //增量同步spu,每7分钟一次
        taskScheduler.addJob("syncIncrementSpuJob","group2","trigger2","t2",EsSyncIncrementSpuJob.class,"0 */7 * * * ?");
        //全量同步sku，每天晚上2点
        taskScheduler.addJob("syncAllSkuJob","group3","trigger3","t3",EsSyncAllSkuJob.class,"0 00 02 * * ?");
        //增量同步sku,每5分钟一次
        taskScheduler.addJob("syncIncrementSkuJob","group4","trigger4","t4", EsSyncIncrementSkuJob.class,"0 */5 * * * ?");
        //全量同步公司自己的sku
        taskScheduler.addJob("syncAllCompanyItemJob","group5","trigger5","t5",EsSyncAllCompanyItemJob.class,"0 00 04 * * ?");
        //增量同步公司自己的sku,每3分钟一次
        taskScheduler.addJob("EsSyncIncrementCompanyItemJob","group6","trigger6","t6",EsSyncIncrementCompanyItemJob.class,"0 */3 * * * ?");
    }
